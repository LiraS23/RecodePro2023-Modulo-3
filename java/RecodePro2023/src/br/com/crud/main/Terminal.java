...
public class Terminal {
    ...
    private static void menuPedido(PedidoDAO pedidoDAO, Scanner scanner) {
        ...
        do {
            ...
            switch (escolha) {
            case 1:
                adicionarPedido(pedidoDAO, scanner);
                break;
                case 2:
    ...
    private static void adicionarPedido(PedidoDAO pedidoDAO, Scanner scanner) {
        ...
        pedido.setValorPedido(new BigDecimal(scanner.nextLine()));
        System.out.println("Informe o ID do pacote associado ao pedido:");
        pedido.setFk_pacote_idPacote(scanner.nextInt());
        scanner.nextLine(); // Consumir a quebra de linha
